...
class SquadsFragment : BaseFragment() {
        ...
        view?.let {
            ...
            val simpleItemTouchCallback: ItemTouchHelper.SimpleCallback = object :
                ...
                override fun onSwiped(viewHolder: RecyclerView.ViewHolder, swipeDir: Int) {
                    ...
                    val message = getString(R.string.warning_delete_squads)
                    val yes = {
                        viewModel.removeSquadAndMatches(adapter.getSquad(position))
                    }
                    val no = {
    ...
    private fun refreshCount() {
        binding.textSquadsTotal.isVisible = Prefs.getBoolean(PreferencesKeys.DEBUG_ON, false)
